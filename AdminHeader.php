        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsNestFurn">
                ...
                <li><a class="nav-link" href="admin.php">Dashboard</a></li>
                        <li><a class="nav-link" href="products_manage.php">Products</a></li>
                        <li><a class="nav-link" href="orders.php">Orders</a></li>
                        <li><a class="nav-link" href="offers.php">Offers</a></li>
                        <li><a class="nav-link" href="carousel_manage.php">Carousel</a></li>
                </ul>
